      ...
      Solve : loop
         ...
         for Current_Lookup of Current_Found loop
            ...
            begin
               ...
               if not Winner_Boards.Contains (Current_Lookup.Board_Id)
                 and then Is_Bingo (Current_Board, Current_Lookup.Line, Current_Lookup.Column)
               then
                  Winner_Boards.Insert (Current_Lookup.Board_Id);

                  if Winner_Boards.Length = Boards.Length then
                     Put ("Result: ");
