...
<article class="day-desc"><p>You come across a field of <a href="https://en.wikipedia.org/wiki/Hydrothermal_vent" target="_blank">hydrothermal vents</a> on the ocean floor! These vents constantly produce large, opaque clouds, so it would be best to avoid them if possible.</p>
...
<p>For now, <strong>only consider horizontal and vertical lines</strong>: lines where either <code>x1 = x2</code> or <code>y1 = y2</code>.</p>
